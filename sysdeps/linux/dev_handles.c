...
int process_ip(u_char *userdata, const pcap_pkthdr * /* header */,
               const u_char *m_packet) {
	/*TWIP*/
	return 0;
}
int process_ip6(u_char *userdata, const pcap_pkthdr * /* header */,
               const u_char *m_packet) 
{
	/*WIP*/
	return 0;
}
int process_tcp(u_char *userdata, const pcap_pkthdr *header /* header */,
               const u_char *m_packet) 
{	/*WIP*/
